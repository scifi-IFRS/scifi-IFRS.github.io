...
function setActiveStyleSheet(title) {
  ...
  for(i=0; (a = document.getElementsByTagName("link")[i]); i++) {
    if(a.getAttribute("rel").indexOf("style") != -1 && a.getAttribute("title")) {
      ...
      if(title == "light-red"){
        mudarImagem('imagemLogo','../images/logos/light-red.png');
      }else if(title == "blue"){
        mudarImagem('imagemLogo','../images/logos/blue.png');
      }else if(title == "green"){
        mudarImagem('imagemLogo','../images/logos/green.png');
      }else if(title == "light-green"){
        mudarImagem('imagemLogo','../images/logos/light-green.png');
      }else if(title == "light-blue"){
        mudarImagem('imagemLogo','../images/logos/light-blue.png');
      }else if(title == "yellow"){
        mudarImagem('imagemLogo','../images/logos/yellow.png');
      }
    }
  }
}
